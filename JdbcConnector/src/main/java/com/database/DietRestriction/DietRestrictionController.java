...
import com.database.UserInfo.UserInfoController;
...
public class DietRestrictionController {
    public static DietRestrictionRepository getDietRestrictionRepository() {
        return dietRestrictionRepository;
    }

    public static void setDietRestrictionRepository(DietRestrictionRepository dietRestrictionRepository) {
        DietRestrictionController.dietRestrictionRepository = dietRestrictionRepository;
    }

    private static DietRestrictionRepository dietRestrictionRepository;
